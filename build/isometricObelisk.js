...
var isometricObelisk = (function() {
    ...
    // Purpose: Reurns Hex color from given rgb string
    // Return format: 0x??????
    ...
    var _paintObject = function() {
        if (_OBJECT.tag == 'cube') {
            if (_OBJECT.colorValues.state == 'full') {
                _OBJECT.finalColor = new obelisk.CubeColor().getByHorizontalColor(_OBJECT.colorValues.general);
            } else {
                _OBJECT.finalColor = new obelisk.CubeColor(0x77000000, 0x77000000, _OBJECT.colorValues.front, _OBJECT.colorValues.side, _OBJECT.colorValues.top);
            }
        } else if (_OBJECT.tag == 'pyramid') {
            if (_OBJECT.colorValues.state == 'full') {
                _OBJECT.finalColor = new obelisk.PyramidColor().getByRightColor(_OBJECT.colorValues.general);
            } else {
                _OBJECT.finalColor = new obelisk.PyramidColor(_OBJECT.colorValues.top, _OBJECT.colorValues.top, _OBJECT.colorValues.front, _OBJECT.colorValues.side);
            }
        } else if (_OBJECT.tag == 'sideX' || _OBJECT.tag == 'sideY') {
            if (_OBJECT.colorValues.state == 'full') {
                _OBJECT.finalColor = new obelisk.SideColor().getByInnerColor(_OBJECT.colorValues.general);
            } else {
                _OBJECT.finalColor = new obelisk.SideColor(_OBJECT.colorValues.side, _OBJECT.colorValues.front);
            }
        } else if (_OBJECT.tag == 'brick') {
            if (_OBJECT.colorValues.state == 'full') {
                _OBJECT.finalColor = new obelisk.SideColor().getByInnerColor(_OBJECT.colorValues.general);
            } else {
                _OBJECT.finalColor = new obelisk.SideColor(_OBJECT.colorValues.side, _OBJECT.colorValues.top);
            }
        } else if (_OBJECT.tag == 'slopeNorth') {
            if (_OBJECT.colorValues.state == 'full') {
                _OBJECT.finalColor = new obelisk.SlopeColor().getByHorizontalColor(_OBJECT.colorValues.general);
            } else {
                _OBJECT.finalColor = new obelisk.SlopeColor(_OBJECT.colorValues.top, _OBJECT.colorValues.top, _OBJECT.colorValues.side, _OBJECT.colorValues.front);
            }
        } else if (_OBJECT.tag == 'slopeEast') {
            if (_OBJECT.colorValues.state == 'full') {
                _OBJECT.finalColor = new obelisk.SlopeColor().getByHorizontalColor(_OBJECT.colorValues.general);
            } else {
                _OBJECT.finalColor = new obelisk.SlopeColor(_OBJECT.colorValues.front, 0x77000000, _OBJECT.colorValues.side, 0x77000000);
            }
        } else if (_OBJECT.tag == 'slopeSouth') {
            if (_OBJECT.colorValues.state == 'full') {
                _OBJECT.finalColor = new obelisk.SlopeColor().getByHorizontalColor(_OBJECT.colorValues.general);
            } else {
                _OBJECT.finalColor = new obelisk.SlopeColor(_OBJECT.colorValues.top, _OBJECT.colorValues.top, 0x77000000, _OBJECT.colorValues.front, _OBJECT.colorValues.side);
            }
    ...
    isometricObelisk.prototype.cube = function(Cube3d) {
        ...
        _OBJECT.finalDimension = new obelisk.CubeDimension(_OBJECT.dimension.x, _OBJECT.dimension.y, _OBJECT.dimension.z);
    ...
    isometricObelisk.prototype.brick = function(Brick3d) {
        ...
        _OBJECT.finalDimension = new obelisk.BrickDimension(_OBJECT.dimension.x, _OBJECT.dimension.y);
    ...
    isometricObelisk.prototype.pyramid = function(Pyramid3d = {}) {
        ...
        if (Pyramid3d.hasOwnProperty('z') && Pyramid3d.z) {
            _OBJECT.finalDimension = new obelisk.PyramidDimension(_OBJECT.dimension.x, Pyramid3d.z);
        } else {
            _OBJECT.finalDimension = new obelisk.PyramidDimension(_OBJECT.dimension.x);
        }
    ...
    isometricObelisk.prototype.sideX = function(SideX3d) {
        ...
        _OBJECT.finalDimension = new obelisk.SideXDimension(_OBJECT.dimension.x, _OBJECT.dimension.y);
    ...
    isometricObelisk.prototype.sideY = function(SideY3d) {
        ...
        _OBJECT.finalDimension = new obelisk.SideYDimension(_OBJECT.dimension.x, _OBJECT.dimension.y);
    ...
    isometricObelisk.prototype.slopeNorth = function(slopeNorth3d) {
        ...
        _OBJECT.finalDimension = new obelisk.SlopeDimension(_OBJECT.dimension.x, _OBJECT.dimension.y);
    ...
    isometricObelisk.prototype.position = function(Coordinates) {
        ...
        _OBJECT.finalPosition = new obelisk.Point3D(_OBJECT.position.x, _OBJECT.position.y, _OBJECT.position.z)
    ...
    isometricObelisk.prototype.render = function() {
        var shapeObj = null;
        if (_OBJECT.tag == 'cube') {
            shapeObj = new obelisk.Cube(_OBJECT.finalDimension, _OBJECT.finalColor, _OBJECT.border);
        } else if (_OBJECT.tag == 'brick') {
            shapeObj = new obelisk.Brick(_OBJECT.finalDimension, _OBJECT.finalColor, _OBJECT.border);
        } else if (_OBJECT.tag == 'pyramid') {
            shapeObj = new obelisk.Pyramid(_OBJECT.finalDimension, _OBJECT.finalColor, _OBJECT.border);
        } else if (_OBJECT.tag == 'sideX') {
            shapeObj = new obelisk.SideX(_OBJECT.finalDimension, _OBJECT.finalColor, _OBJECT.border);
        } else if (_OBJECT.tag == 'sideY') {
            shapeObj = new obelisk.SideY(_OBJECT.finalDimension, _OBJECT.finalColor, _OBJECT.border);
        } else if (_OBJECT.tag == 'slopeNorth') {
            shapeObj = new obelisk.SlopeNorth(_OBJECT.finalDimension, _OBJECT.finalColor, _OBJECT.border);
        } else if (_OBJECT.tag == 'slopeEast') {
            shapeObj = new obelisk.SlopeEast(_OBJECT.finalDimension, _OBJECT.finalColor, _OBJECT.border);
        } else if (_OBJECT.tag == 'slopeSouth') {
            shapeObj = new obelisk.SlopeSouth(_OBJECT.finalDimension, _OBJECT.finalColor, _OBJECT.border);
        } else if (_OBJECT.tag == 'slopeWest') {
            shapeObj = new obelisk.SlopeWest(_OBJECT.finalDimension, _OBJECT.finalColor, _OBJECT.border);
        }
